...
//            JWSHeader header = new JWSHeader(JWSAlgorithm.HS256);
    ...
    public void testSignatureSign() {
        ...
        try {
            ...
            byte [] rsaPrivateKey = FileUtil.readAllBytes(JOSEUtilTest.class.getResourceAsStream("/resources/private-rsa-key.pem"));
            {
    ...
    public void testBase64() {
        try {
            ...
            byte [] privateKey = FileUtil.readAllBytes(JOSEUtilTest.class.getResourceAsStream("/resources/private-rsa-key.pem"));
            {
