...
import extension.helpers.jose.WeakMACProvider;
...
public class AttackMACVerifier extends WeakMACProvider implements JWSVerifier {
    ...
    public AttackMACVerifier(final String secretString) {
    ...
    public AttackMACVerifier(final List<SecretKey> attackList) {
    ...
    public List<SecretKey> getAttackList() {
