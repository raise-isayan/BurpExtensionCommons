...
//                    api.proxy().isInterceptEnabled();
    ...
    public static BurpConfig.InterceptClientRequests getInterceptClientRequests(MontoyaApi api) {
        ...
        requests.setAutomaticallyUpdateContentLengthHeader(request_json.get("automatically_update_content_length_header_when_the_request_is_edited").getAsBoolean());
        requests.setAutomaticallyFixMissingOrSuperfluousNewLines(request_json.get("automatically_fix_missing_or_superfluous_new_lines_at_end_of_request").getAsBoolean());
    ...
    static String updateInterceptClientRequests(String config, BurpConfig.InterceptClientRequests requests) {
        ...
        intercept_json.addProperty("automatically_update_content_length_header_when_the_request_is_edited", requests.isAutomaticallyUpdateContentLengthHeader());
        intercept_json.addProperty("automatically_fix_missing_or_superfluous_new_lines_at_end_of_request", requests.isAutomaticallyFixMissingOrSuperfluousNewLines());
    ...
    public static class InterceptClientRequests {
        ...
        @Expose
        private boolean do_intercept = true;

        @Expose
        private boolean automatically_fix_missing_or_superfluous_new_lines_at_end_of_request = false;

        @Expose
        private boolean automatically_update_content_length_header_when_the_request_is_edited = true;
        ...
        /**
         * @return the
         * automatically_fix_missing_or_superfluous_new_lines_at_end_of_request
         */
        public boolean isAutomaticallyFixMissingOrSuperfluousNewLines() {
            return automatically_fix_missing_or_superfluous_new_lines_at_end_of_request;
        }
         ...
         * to set
         */
        public void setAutomaticallyFixMissingOrSuperfluousNewLines(boolean automatically_fix_missing_or_superfluous_new_lines_at_end_of_request) {
            this.automatically_fix_missing_or_superfluous_new_lines_at_end_of_request = automatically_fix_missing_or_superfluous_new_lines_at_end_of_request;
        }

        /**
         * @return the
         * automatically_update_content_length_header_when_the_request_is_edited
         */
        public boolean isAutomaticallyUpdateContentLengthHeader() {
            return automatically_update_content_length_header_when_the_request_is_edited;
        }
         ...
         * to set
         */
        public void setAutomaticallyUpdateContentLengthHeader(boolean automatically_update_content_length_header_when_the_request_is_edited) {
            this.automatically_update_content_length_header_when_the_request_is_edited = automatically_update_content_length_header_when_the_request_is_edited;
        }
    ...
    static String updateInterceptServerResponses(String config, BurpConfig.InterceptServerResponses response) {
        ...
        intercept_json.addProperty("automatically_update_content_length_header_when_the_response_is_edited", response.isAutomaticallyUpdateContentLengthHeader());
    ...
    public static class InterceptServerResponses {
        ...
        @Expose
        private boolean do_intercept = false;

        @Expose
        private boolean automatically_update_content_length_header_when_the_response_is_edited = true;
         ...
         */
        public boolean isAutomaticallyUpdateContentLengthHeader() {
            return automatically_update_content_length_header_when_the_response_is_edited;
        }
         ...
         * to set
         */
        public void setAutomaticallyUpdateContentLengthHeader(boolean automatically_update_content_length_header_when_the_response_is_edited) {
            this.automatically_update_content_length_header_when_the_response_is_edited = automatically_update_content_length_header_when_the_response_is_edited;
        }
