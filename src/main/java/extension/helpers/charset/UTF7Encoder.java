...
public class UTF7Encoder extends CharsetEncoder {
     ...
     * thus cannot be overridden).</p>
     *
     * @see
     * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6227608">JDK
     * bug 6227608</a>
     ...
     * to indicate if a broken java version is used.</p>
     * <p>
     * It is not possible to directly write the last few bytes, since more bytes
     * might be waiting to be encoded then those available in the input
     * buffer.</p>
     *
     * @see
     * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6221056">JDK
     * bug 6221056</a>
     ...
     * include an unshift character.</p>
     *
     * @param out
     * @param ch
     */
     ...
     * the bytes not yet fully determined.</p>
     *
     * @param out
     * @param ch
     */
