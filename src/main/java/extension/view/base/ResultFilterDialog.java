 ...
 * @author isayan
 */
public class ResultFilterDialog extends CustomDialog {

    /**
     * Creates new form ResultFilterDlg
     */
    public ResultFilterDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        customizeComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultFilterDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ResultFilterDialog dialog = new ResultFilterDialog(new javax.swing.JFrame(), true);
    ...
    public void setBambaMode(boolean bamba) {
        this.tabbetFilter.remove(pnlBambda);
        if (bamba) {
            this.tabbetFilter.addTab("Bambda", pnlBambda);
        }
    }
